...
urlpatterns = [
    ...
    path("testimonials/<str:sku>/", TestimonialAPIView.as_view(), name='testimonial-detail'),
    ...
    path("experiences/<str:sku>/", ExperienceAPIView.as_view(), name='experience-detail'),

    path("certifications/", CertificationAPIView.as_view(), name='certification-list'),
    path("certifications/<str:sku>/", CertificationAPIView.as_view(), name='certification-detail'),
]
